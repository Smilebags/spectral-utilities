...
fillCanvasWithColour(blackEl, new Colour(new Vec3(0.3128, 0.3290, 0), 'xyY').toXYZ());
fillCanvasWithColour(greyEl, new Colour(new Vec3(0.3128, 0.3290, 0.5), 'xyY').toXYZ());
fillCanvasWithColour(whiteEl, new Colour(new Vec3(0.3128, 0.3290, 0.99), 'xyY').toXYZ());
