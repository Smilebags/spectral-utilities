...
const stepsEl = document.querySelector('#steps') as HTMLInputElement;
const multipleEl = document.querySelector('#multiple') as HTMLInputElement;
...
function drawSwatches(stepPower: number, multiple: number): void {
