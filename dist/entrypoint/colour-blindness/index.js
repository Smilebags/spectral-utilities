...
const colourCanvas = document.getElementById("colour");
...
setupObservers();
redraw();
function render(colourCtx, humanObserver) {
    drawSpectrumToRegion(new SrgbSpectrum(sRGBToIntensityLookups, 1, 0, 0), { x: 0, y: 0, width: 0.25, height: 0.5 });
    drawSpectrumToRegion(new SrgbSpectrum(sRGBToIntensityLookups, 0, 1, 0), { x: 0.25, y: 0, width: 0.25, height: 0.5 });
    drawSpectrumToRegion(new SrgbSpectrum(sRGBToIntensityLookups, 0, 0, 1), { x: 0.5, y: 0, width: 0.25, height: 0.5 });
    drawSpectrumToRegion(new SrgbSpectrum(sRGBToIntensityLookups, 1, 1, 1), { x: 0.75, y: 0, width: 0.25, height: 0.5 });
    drawSpectrumToRegion(new SrgbSpectrum(sRGBToIntensityLookups, 0, 1, 1), { x: 0, y: 0.5, width: 0.25, height: 0.5 });
    drawSpectrumToRegion(new SrgbSpectrum(sRGBToIntensityLookups, 1, 0, 1), { x: 0.25, y: 0.5, width: 0.25, height: 0.5 });
    drawSpectrumToRegion(new SrgbSpectrum(sRGBToIntensityLookups, 1, 1, 0), { x: 0.5, y: 0.5, width: 0.25, height: 0.5 });
    drawSpectrumToRegion(new SrgbSpectrum(sRGBToIntensityLookups, 0, 0, 0), { x: 0.75, y: 0.5, width: 0.25, height: 0.5 });
    function drawSpectrumToRegion(spectrum, region) {
